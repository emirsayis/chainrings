...
let contractRW
let signer
let contractAddress = "0xbfb2997f9551dc729ee5301757dd373be42f75a2"
let baseURI = "https://chainrings.art"
let infuraAPI = "https://mainnet.infura.io/v3/005d6ca6dd524825be097030663f145d"
let supply
let price = 0.05
...
async function mint() {
    ...
    if (amount > 0) {
        ...
        const tx = await contractRW.mintRings(amount, {value: value})
